      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex min-h-svh w-full has-[[data-variant=inset]]:bg-card overflow-hidden",
              className
            )}
            ref={ref}
            {...props}
    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="font-sans flex h-full w-full flex-col bg-[hsl(220_40%_90%)] dark:bg-card group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "scrollbar-thin scrollbar-thumb-accent scrollbar-track-primary",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="group"
      className={cn("relative flex w-full min-w-0 flex-col px-3 group-data-[collapsible=icon]:px-2", className)}
      {...props}
    />
  )
})
  ...
  (
    ...
    const button = (
      <Comp
        ...
        className={cn(sidebarMenuButtonVariants({ variant, size }), "whitespace-nowrap truncate", className)}
        {...props}
      >
        {children}
      </Comp>
